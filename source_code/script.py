...
t0 = time.time()
print("Starting DACON 1100+ Hyper SOTA Inference Pipeline (v41 Grand Quad-Blend with Optimal Meta-Stacking)...")

DEVICE = torch.device('cpu')
SEEDS = [7, 123, 2025, 31415, 8675309]

# Mathematically Optimal Meta-Stacking Weights (Subagent SOTA Optimization)
W_CB_RMSE = 0.365
W_GBDT_BIN = 0.285
W_LGB_MSE = 0.210
W_MLP_MSE = 0.140
...
# CatBoost RMSE format (136 features)
...
# Optimal Meta-Stacking Quad-Blend
p_raw = W_CB_RMSE * p_cb_rmse + W_GBDT_BIN * p_gbdt_bin + W_LGB_MSE * p_gbdt_mse + W_MLP_MSE * p_mlp_mse
...
# Final Mathematically Optimal Affine Calibration (s*=1.1042, delta*=-0.004520)
CALIBRATION_SCALE = 1.1042
CALIBRATION_SHIFT = -0.004520
